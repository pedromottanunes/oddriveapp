...
function ok(res, data){ res.setHeader("Content-Type","application/json"); res.end(JSON.stringify(data)); }
function bad(res, msg, code=400){ res.statusCode=code; res.end(msg); }
...
function userFromContext(context){
  // Netlify injeta user no clientContext quando Identity está habilitado
...
module.exports = { ok, bad, cors, userFromContext, googleClients, sheetAppend, sheetReadAll, ensureFolder, uploadPhoto };